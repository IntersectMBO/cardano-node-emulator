...
tests =
  testGroup
    ...
    , testGroup
        ...
        , testPropertyNamed
            "slot number >=0 when converting from time"
            "slotIsPositiveProp,"
            slotIsPositiveProp
        , testPropertyNamed
            "slotRange to timeRange inverse property"
            "slotToTimeInverseProp,"
            slotToTimeInverseProp
        , testPropertyNamed
            "timeRange to slotRange inverse property"
            "timeToSlotInverseProp,"
            timeToSlotInverseProp
        , testPropertyNamed
            "slot to time range inverse to slot range"
            "slotToTimeRangeBoundsInverseProp"
            slotToTimeRangeBoundsInverseProp
        , testPropertyNamed
            "slot to time range has lower bound <= upper bound"
            "slotToTimeRangeHasLowerAndUpperBoundsProp"
            slotToTimeRangeHasLowerAndUpperBoundsProp
        , testPropertyNamed
            "POSIX time to UTC time inverse property"
            "posixTimeToUTCTimeInverseProp"
            posixTimeToUTCTimeInverseProp
        ]
    , testGroup
        "Signing"
...
slotToTimeRangeBoundsInverseProp = property $ do
  ...
  let slotRange =
        PlutusTx.fmap
          (TimeSlot.posixTimeToEnclosingSlot sc)
